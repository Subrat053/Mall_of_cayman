...
const AboutUsPage = () => {
  ...
  if (legalPage && !error) {
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative bg-gradient-to-br from-blue-600 to-red-600 py-20 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/products"
                className="px-8 py-4 bg-white text-blue-600 font-bold rounded-xl hover:bg-blue-50 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
              >
                Explore Products
              </Link>
              <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Contact Section */}
          <section className="py-20">
            <div className="bg-gradient-to-br from-blue-600 to-red-600 rounded-2xl p-12 text-white text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-blue-100">support@mallofcayman.com</p>
                </div>
              </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-blue-400 via-purple-300 to-red-400 py-20 overflow-hidden">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-white/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-300/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
