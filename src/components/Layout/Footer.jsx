...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="relative bg-indigo-95000 py-8">
      ...
      <div className="relative bg-cyan-400500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center mb-4">
                <Link to="/" className="group">
                  <img
                    src={BrandingLogo}
                    alt="Brand Logo"
                    className="h-20 w-auto object-contain transition-all duration-300 scale-150 group-hover:scale-110 drop-shadow-lg"
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-start space-x-2">
                  <HiOutlineLocationMarker className="w-4 h-4 text-blue-500 mt-0.5 flex-shrink-0" />
                  <span className="text-indigo-100 text-xs leading-tight">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-indigo-100 text-xs">
                    {siteSettings?.footerAddress?.email || "support@mallofcayman.in"}
                  </span>
                </div>
              </div>
            </div>
            ...
            {/* Shop Links */}
            <div>
              <h3 className="text-lg font-bold mb-4 text-blue-500">Shop</h3>
                ...
                {footerProductLinks.map((link, index) => (
                  <li key={index}>
                    <Link
                      to={link.link}
                      onClick={scrollToTop}
                      className="text-white hover:text-red-700 transition-colors duration-300 text-sm"
                    >
                      {link.name}
                    </Link>
                  </li>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    to="/products"
                    onClick={scrollToTop}
                    className="text-white hover:text-red-500 transition-colors duration-300 text-sm"
                  >
                    Products
                  </Link>
                </li>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-white text-xs">SSL Secured</span>
                </div>
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-white text-xs">Top Rated</span>
                </div>
              </div>
            </div>
          </div>
