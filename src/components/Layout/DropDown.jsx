...
const DropDown = ({ categoriesData, setDropDown }) => {
  ...
  return (
    <div className="absolute top-full left-0 mt-3 w-64 bg-white border border-indigo-200 rounded-lg shadow-unacademy-lg z-50 py-2 animate-slideInDown backdrop-blur-sm">
      {/* Header */}
          ...
          categoriesData.map((i, index) => (
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="text-sm font-medium text-text-primary group-hover:text-indigo-500 transition-colors duration-200 select-none">
                  {i.name || i.title}
                </h3>
              </div>
