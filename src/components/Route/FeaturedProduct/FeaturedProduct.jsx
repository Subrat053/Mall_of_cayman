...
const FeaturedProduct = () => {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-blue-500 via-white to-red-500 py-16">
  ...
  return (
    <section className="border-t-2 border-gray-300 py-6 sm:py-8">
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
        {/* Modern Header Section */}
        <div className="text-center mb-6">
          {/* Badge */}
          <div className="inline-flex items-center mb-4">
            <div className="flex items-center space-x-2 bg-gradient-to-r from-cyan-500 to-indigo-500 text-white px-4 py-2 rounded-full shadow-md">
          ...
          {/* Subtitle */}
          <p className="text-base text-slate-600 max-w-2xl+2 mx-auto leading-relaxed">
        ...
        {data && data.length !== 0 ? (
          <>
            ...
            <div className="mb-6">
              ...
              <div className="hidden md:grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 auto-rows-fr ">
                {data.map((product, index) => (
                  <div
                    key={index}
                  ...
                  >
                    <div className="relative h-full">
                      ...
                      {index < 3 && (
                        <div className="absolute top-2 -right-1 z-20">
                          <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs font-bold px-2 py-1 me-2 rounded-full shadow-lg ">
                            ✨ FEATURED
                          </div>
                        </div>
                      )}
