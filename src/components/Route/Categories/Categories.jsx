    ...
    <section className=" py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <div className="text-center mb-10">
            ...
            <div className="flex justify-center items-center space-x-4 mt-4">
              <div className="flex items-center space-x-1 text-gray-700">
                <HiStar className="w-4 h-4 text-green-500" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4 mb-10">
            {categoriesData &&
              categoriesData.map((category, index) => {
                ...
                return (
                  <div
                    ...
                    className="group relative bg-white  shadow-lg hover:shadow-xl border border-gray-100 hover:border-blue-200 transition-all duration-500 cursor-pointer overflow-hidden transform  hover:scale-105"
                  ...
                  >
                    ...
                    {/* Animated Border */}
                    <div className="absolute inset-0 border-2 border-transparent group-hover:border-cyan-300  transition-all duration-300"></div>
